...
<body>
	...
	<div id="container">
		...
		<form action="issueone.php" method="post">
			<font style="font-family: impact, sans-serif;font-size:200%;color: white">Issued Books</font><br><br>
			<div>
				<table id="example2">
					<thead>
						<tr>
					...
					<tbody>
						<?php					
							$sql="select Issue_ID,Member_ID,Member_Name,Membership_type,Contact_no,Book_name,Author_name,Issue_date,Return_date from books natural join issue natural join member where Member_ID='$loginsession'";
