	...
	<div id="container">
		<aside>
			<ul>
				...
				<li><a href="member.html">Member Entry</a>
				<li><a href="penalty.html">Penalty Entry</a>
			</ul>
		</aside>
		<div id="main">
		<form action="add_booksone.php" method="post">
			...
			<tr>
				<th>Book Name:</th>
				<td><input type="text" name="book_name" placeholder="Enter Book Name"></td>
			</tr>
			<tr>
				<th>Book Type:</th>
				<td>
			...
			<tr>
				<th>No. of copies:</th>
				<td><input type="number" name="no_of_copies" placeholder="Enter No. of Copies"></td>
			</tr>
			<tr>
				<th>Subject:</th>
			...
			<tr>
				<th>Book Image:</th>
                <td><input type="file" name="image" id="inputEmail3"></td>
			</tr>
			</table></center>
			<br>
			<button class="submit btn btn-danger1" type="submit" name="submit">Add book into Database</button>
		</form>
		</div>
	</div>
</body>
